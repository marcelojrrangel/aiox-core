...
export class ContextCollector {
    ...
    async collectProjectContext(rootDir = process.cwd()) {
    ...
    async collectFileContext(filePaths) {
        const results = [];
    ...
    scanDirectory(dir, rootDir, depth) {
        if (depth > MAX_DEPTH)
            return [];
        const results = [];
        try {
    ...
    extractContextInfo(filePath, rootDir) {
